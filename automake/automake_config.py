...
compiler = "clang++"
cflags = "-std=c++20 -Wall -Wno-unused-command-line-argument -Wno-unused-variable -Ivendor"
...
automake.Make_makefile(compiler,client_flags,shared_src + ["src/server"],"server")
